/// Library for printing images to terminal.
/// Basically taken out of the `termpix` crate, which is a utility program,
/// and put into a separate library.
...
use self::image::{imageops, FilterType, Pixel};
